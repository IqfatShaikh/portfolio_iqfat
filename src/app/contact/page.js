                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex justify-center space-x-6">
                      <a
                        ...
                        className="w-14 h-14 bg-slate-700 hover:bg-slate-600 rounded-2xl flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110 hover:-translate-y-2 group/social shadow-lg hover:shadow-slate-500/50"
                        aria-label="GitHub"
                      >
                        <svg className="w-7 h-7 group-hover/social:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-14 h-14 bg-blue-600 hover:bg-blue-500 rounded-2xl flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110 hover:-translate-y-2 group/social shadow-lg hover:shadow-blue-500/50"
                        aria-label="LinkedIn"
                      >
                        <svg className="w-7 h-7 group-hover/social:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-14 h-14 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 hover:from-purple-500 hover:via-pink-500 hover:to-orange-400 rounded-2xl flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110 hover:-translate-y-2 group/social shadow-lg hover:shadow-pink-500/50"
